import { bigint, check, foreignKey, integer, jsonb, pgTable, primaryKey, text, timestamp, uuid, boolean } from "drizzle-orm/pg-core";
...
// composite table : primary key가 여러 column으로 이루어진 경우
